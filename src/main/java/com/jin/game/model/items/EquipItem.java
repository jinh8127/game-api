...
public abstract class EquipItem extends GameItem implements Wearable {
    ...
    public EquipItem(String itemName, ItemType itemType, Boolean isExchangeable, Boolean isDisposable, Integer levelReq, Integer strReq, Integer dexReq, Integer lukReq, Integer intReq, Integer strength, Integer dexterity, Integer luck, Integer intelligence, Integer physicalArmor, Integer magicArmor) {
